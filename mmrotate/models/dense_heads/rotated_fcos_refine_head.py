...
from mmrotate.core.bbox.p2b_utils.merge_bbox import merge_rbox
...
class RotatedFCOSRefineHead(RotatedAnchorFreeHead):
    ...
    def filter_box(self, bbox_results, proposals_list, gt_labels, gt_point, img_metas):
        ...
        bbox_results['bbox_feats'] = bbox_results['bbox_feats'].reshape(num_gt_num_gen, 5, -1)[
            torch.arange(num_gt_num_gen).unsqueeze(-1), idx.reshape(-1, k)].reshape(num_gt, -1,
                                                                                    bbox_results['bbox_feats'].shape[                                                                                -1])
    ...
    #     weights *= (rbbox_overlaps(a, b, is_aligned=True) > 0.3)[..., None]
    ...
    def _get_target_single(self, gt_bboxes, gt_labels, points, regress_ranges,
        ...
        # print('bbox_targets: labels: \n', bbox_targets.shape,labels.shape)
    ...
    def get_bboxes(self,
        ...
        for img_id in range(len(img_metas)):
            ...
            det_bboxes = self._get_bboxes_single(cls_score_list,
                                                 ...
                                                 scale_factor, cfg, img_metas, rescale)
            # 6维参数
    ...
    def _get_bboxes_single(self,
        ...
        # nms操作 score_thr=0.05 mlvl_scores为分类score
        det_bboxes, det_labels, ids = multiclass_nms_rotated(
            mlvl_bboxes,
            mlvl_scores,
            cfg.score_thr,
            cfg.nms,
        ...
        merge_mode = 'CBP'
        cls_scores = det_bboxes[...,5:]
        # proposals = det_bboxes[:,:5]
        
        det_mbboxes = merge_rbox(det_bboxes, cls_scores,img_metas)
