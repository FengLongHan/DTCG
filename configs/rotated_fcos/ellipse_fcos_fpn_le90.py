...
model = dict(
    ...
    bbox_head=dict(
        ...
        # bbox_coder=dict(
        #     type='DistancePointBBoxCoder', angle_version=angle_version),
        loss_cls=dict(
            type="FocalLoss", use_sigmoid=True, gamma=2.0, alpha=0.25, loss_weight=1.0
        ),
        loss_bbox=dict(type="RotatedIoULoss", loss_weight=1.0),
        # loss_bbox=dict(type='GIoULoss', loss_weight=1.0),
        # loss_l1_bbox =dict(type='SmoothL1Loss', loss_weight=0.1),
        # loss_ellipse_bbox=dict(type='SmoothL1Loss', loss_weight=0.2),
