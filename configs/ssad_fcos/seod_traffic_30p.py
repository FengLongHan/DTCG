...
data = dict(
    ...
    train=dict(
        sup=dict(
            ann_file=data_root + "proportion/train_30_labeled/annos/",
            img_prefix=data_root + "proportion/train_30_labeled/images/",
            classes=classes,
        ),
        unsup=dict(
            ann_file=data_root + "proportion/train_30_unlabeled/annos/",
            img_prefix=data_root + "proportion/train_30_unlabeled/images/",
            classes=classes,
        ),
    ),
    sampler=dict(
